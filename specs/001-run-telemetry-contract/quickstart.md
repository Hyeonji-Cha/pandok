# Quickstart: Validate the P0 Telemetry Contract
...
Expected outcome: all contract, privacy, fixture, and sequence tests pass. See [data-model.md](data-model.md)
for entity rules and [telemetry-events-v1.md](contracts/telemetry-events-v1.md) for delivery semantics.
